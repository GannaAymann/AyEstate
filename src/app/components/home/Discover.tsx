        ...
        <div className='flex flex-col bg-[#F6F3F3] pt-[50px] items-center justify-center lg:justify-around lg:flex-row lg:h-[600px] h-[805px]'>
            <div className='text-center lg:text-start flex flex-col '>
                ...
                <div className='flex flex-row items-center justify-center lg:items-start lg:justify-start gap-x-[16px] mt-[24px] xl:mt-[80px]'>
                    <Button className='rounded-[12px] bg-app-lightgreen text-black hover:bg-app-lightgreen text-[16px] font-[600] leading-[24px]'>Explore Now</Button>
                    <Button className='rounded-[12px] bg-transparent border-black border-solid border-[1px] text-black hover:bg-transparent text-[16px] font-[400] leading-[24px]'>Learn More</Button>
                </div>
            </div>
